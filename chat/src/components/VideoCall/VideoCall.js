...
function VideoCall() {
  ...
  function toggleVideo() {
    if (
      ...
      localRef.current.srcObject.getVideoTracks()[0].enabled =
        !switchVideo.video_switch;
      setSwitchVideo({
  ...
  function toggleMic() {
    if (
      ...
      localRef.current.srcObject.getAudioTracks()[0].enabled =
        !switchVideo.mic_switch;
      setSwitchVideo({
        mic_switch: !switchVideo.mic_switch,
        video_switch: switchVideo.video_switch,
      });
    ...
    <div className="videos">
      ...
      <div className="buttonsContainer">
        ...
        <div tabIndex={0} role="button" className="more button">
          <div className="text-center mt-1 ml-1 text-black">
            <MoreIcon />
          </div>

          <div className="popover w-2/3 px-3 z-50">
            {/* hard code link */}
            <button
              onClick={() => {
              ...
              className='ml-4 hover:bg-slate-90 text-black z-50'
            >
              Copy join code
            </button>
          </div>
